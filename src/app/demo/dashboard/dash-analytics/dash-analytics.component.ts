  ...
  constructor() {
    this.chartOptions = {
      ...
      series: [
        ...
        // },
        // {
        //   name: 'Región del Libertador General Bernaddo Ohiggins',
        //   data: [200]
        // },
        // {
        ...
        // },
        // {
        //   name: 'Región de Aysén y del General Carlos Ibañes del Campo',
        //   data: [200]
        // },
        // {
  ...
  cards = [
    {
      ...
      title: 'Total Comunidad',
      icon: 'icon-users',
      text: 'Integrantes en agrupaciones activas',
      number: '409',
      no: ''
    },
    {
      background: 'bg-c-green',
      title: 'Total Agrupaciones',
      icon: 'icon-star',
      text: 'Cantidad de agrupaciones registradas',
      number: '7',
      no: ''
    },
    {
      ...
      icon: 'icon-user',
      text: 'Incorporaciones en el último mes',
      number: '10',
      no: ''
    },
    {
      background: 'bg-c-red',
      title: 'Regíon con más integrantes',
      icon: 'icon-map-pin',
      text: 'Cantidad de integrantes en la región',
      number: 'Metropolitana',
      no: '184'
    }
  ];
